...
const Add = ({addMovie , addToWatched}) => {
  ...
  return (
        ...
        <input className='bg-slate-900 text-white w-[600px] h-[40px] rounded-lg ' type="search" name="searchbar" placeholder='Search Movie' value={inpChange} onChange={ (e) => setInpChange(e.target.value) } />
        </div>
